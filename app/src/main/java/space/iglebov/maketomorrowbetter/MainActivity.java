...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        switch(level){
            case 0: button_start.setVisibility(View.VISIBLE);
                    button_continue.setVisibility(View.GONE);
                    button_newgame.setVisibility(View.GONE);break;
            case 1: button_start.setVisibility(View.GONE);
                    button_continue.setVisibility(View.VISIBLE);
                    button_newgame.setVisibility(View.VISIBLE);break;
            case 2: button_start.setVisibility(View.GONE);
                    button_continue.setVisibility(View.VISIBLE);
                    button_newgame.setVisibility(View.VISIBLE);break;
            case 3: button_start.setVisibility(View.GONE);
                    button_continue.setVisibility(View.VISIBLE);
                    button_newgame.setVisibility(View.VISIBLE);break;
            case 4: button_start.setVisibility(View.GONE);
                    button_continue.setVisibility(View.VISIBLE);
                    button_newgame.setVisibility(View.VISIBLE);break;
            case 5: button_start.setVisibility(View.GONE);
                    button_continue.setVisibility(View.VISIBLE);
                    button_newgame.setVisibility(View.VISIBLE);break;
            case 6: button_start.setVisibility(View.GONE);
                    button_continue.setVisibility(View.VISIBLE);
                    button_newgame.setVisibility(View.VISIBLE);break;
            case 7: button_start.setVisibility(View.VISIBLE);
                    button_continue.setVisibility(View.GONE);
                    button_newgame.setVisibility(View.GONE);break;
        }
